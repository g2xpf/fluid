...
class World {
    ...
    _solve(){
        ...
        for(var i = 0; i < len; ++i){
            ...
            var fx = p1.fx, fy = p1.fy, fz = p1.fz; var fr = fx*fx+fy*fy+fz*fz;
            var fLim = 100;
            if(fr >= fLim * fLim){
                p1.fx *= fLim / sqrt(fr);
                p1.fy *= fLim / sqrt(fr);
    ...
    confine(width, height, pixPerMeter){
        width /= pixPerMeter;
        height /= pixPerMeter;
        var ratio = 0.34;
        var strength = 0.9;
    ...
    _integrate(){
        ...
        Ary.map(particle => {
            ...
            //var r2 = particle.vx * particle.vx + particle.vy * particle.vy;
            //if(r2 > 100){
            //    particle.vx *= 10 / sqrt(r2);
            //    particle.vy *= 10 / sqrt(r2);
            //}
